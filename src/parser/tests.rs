...
fn test_variable_initialization() {
    ...
    // Operator priority
    assert_eq!(
        parse_external_declarations(r#"int abcd = 1 + 2 * 3;"#),
        vec![ExtDecl::Decl(Decl(
            None,
            QualifiedType(
                UnqualifiedType::Basic(BasicType::Int),
            ...
            vec![(
                "abcd".to_string(),
                vec![],
                Some(Initializer::Single(ConstExpr::BinaryOp(
                    BinaryOp::Add,
                    Box::new(ConstExpr::Literal(Literal::Integer(
                        "1".to_string(),
                        IntegerRepr::Dec,
    ...
    // Initializer list
    assert_eq!(
        parse_external_declarations(r#"int a[] = {1, 2, 3};"#),
        vec![ExtDecl::Decl(Decl(
            None,
            QualifiedType(
                UnqualifiedType::Basic(BasicType::Int),
            ...
            vec![(
                ...
                Some(Initializer::List(vec![
                    Initializer::Single(ConstExpr::Literal(Literal::Integer(
                        "1".to_string(),
                        IntegerRepr::Dec,
                        None
                    ))),
    ...
    assert_eq!(
        parse_external_declarations(r#"int a[][3] = {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};"#),
        vec![ExtDecl::Decl(Decl(
            None,
            QualifiedType(
                UnqualifiedType::Basic(BasicType::Int),
            ...
            vec![(
                ...
                vec![
                    ...
                    Deriv::Array(ArraySize::Unspecified)
                ],
                Some(Initializer::List(vec![
